...
RSpec.describe GramsController, type: :controller do
  ...
  describe 'grams#update action' do
    ...
    it 'should have http 404 error if the gram isnt found' do
      user = FactoryGirl.create(:user)
      sign_in user
      patch :update, id: "Yoloswag", gram: {message: "Changd"}
      expect(response).to have_http_status(:not_found)
    end
  ...
  describe 'grams#edit action' do
    it "shouldn't let a user who did not create the gram, edit it" do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
      get :edit, id: gram.id
  ...
  describe 'grams#show action' do
    it 'should sucessfully show the page if the gram is found' do
      gram = FactoryGirl.create(:gram)
      get :show, id: gram.id
      expect(response).to have_http_status(:success)
    end
